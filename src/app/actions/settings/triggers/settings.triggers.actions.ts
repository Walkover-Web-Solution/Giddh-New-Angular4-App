...
export class SettingsTriggersActions {
  ...
  public CreateTrigger$: Observable<Action> = this.action$
    ...
    .switchMap((action: CustomActions) => {
      return this.settingsTriggersService.CreateTrigger(action.payload)
  ...
  public UpdateTrigger$: Observable<Action> = this.action$
    ...
    .switchMap((action: CustomActions) => {
      return this.settingsTriggersService.UpdateTrigger(action.payload, action.payload.uniqueName)
  ...
  public DeleteTrigger$: Observable<Action> = this.action$
    ...
    .switchMap((action: CustomActions) => {
      return this.settingsTriggersService.DeleteTrigger(action.payload)
