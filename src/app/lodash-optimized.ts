...
const {clone, cloneDeep, concat, difference, differenceBy, each, filter, find, findIndex, flatten, flattenDeep, forEach, groupBy, includes, indexOf, isEmpty, isEqual, isNull, isNumber, isString, isUndefined, last, map, omit, orderBy, range, reject, remove, sortBy, sumBy, toArray, union, unionBy, uniq, without, uniqBy, some, intersection} = lodash;
...
export {
  ...
  isEqual, uniqBy, some, intersection
};
