...
export const INVENTORY_API = {
  ...
  STOCK_REPORT: Configuration.ApiUrl + 'company/:companyUniqueName/stock-group/get-stock-report?count=10&from=&page=0&stockGroupUniqueName=&stockUniqueName=d&to=', // get call
};
