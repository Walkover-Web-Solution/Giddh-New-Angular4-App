...
export const INVENTORY_API = {
  ...
  MANUFACTURING_STOCKS: Configuration.ApiUrl + 'company/:companyUniqueName/stocks-manufacture?refresh=true', // get call
  CREATE_NEW_MANUFACTURING_STOCKS: Configuration.ApiUrl + 'company/:companyUniqueName/stocks?isManufactured=true&refresh=true', // get call
