...
export const INVENTORY_API = {
  ...
  MANUFACTURING_STOCKS: Configuration.ApiUrl + 'company/:companyUniqueName/stocks-manufacture', // get call
  CREATE_NEW_MANUFACTURING_STOCKS: Configuration.ApiUrl + 'company/:companyUniqueName/stocks?isManufactured=true', // get call
