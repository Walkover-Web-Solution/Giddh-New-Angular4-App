...
export const INVOICE_API = {
  ...
  PREVIEW_AND_GENERATE: Configuration.ApiUrl + 'v2/company/:companyUniqueName/accounts/:accountUniqueName/invoices/preview',
  ...
  PREVIEW_INVOICE: Configuration.ApiUrl + 'v2/company/:companyUniqueName/accounts/:accountUniqueName/invoices/preview',
  // GET_INVOICE_TEMPLATE_DETAILS: COMMON_URL + 'templates-v2/:templateUniqueName', // get call for single template details
  GET_INVOICE_TEMPLATE_DETAILS: Configuration.ApiUrl  + 'v2/company/:companyUniqueName/templates/:templateUniqueName', // get call for single template details
