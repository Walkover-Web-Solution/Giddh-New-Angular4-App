...
console.log('🎯 Angular Material Import Optimizer - Reducing Bundle Size');
console.log('==========================================================');
...
class MaterialImportOptimizer {
    ...
    optimizeFile(filePath) {
        try {
            ...
            if (optimizations > 0) {
                ...
                console.log(`✅ ${path.relative(process.cwd(), filePath)} (${optimizations} imports optimized)`);
            }
    ...
    run() {
        ...
        console.log(`📄 Found ${filesToOptimize.length} files with Material imports\n`);
        ...
        // Generate report
        console.log('\n📊 MATERIAL IMPORT OPTIMIZATION REPORT:');
        console.log('======================================');
        console.log(`📄 Files processed: ${this.processedFiles}`);
        console.log(`✅ Files optimized: ${this.optimizedFiles}`);
        console.log(`🎯 Total optimizations: ${this.totalSavings}`);
        console.log(`💾 Estimated bundle reduction: ${this.totalSavings * 50}KB - ${this.totalSavings * 200}KB`);
        
        console.log('\n✅ Material import optimization completed!');
    }
}
