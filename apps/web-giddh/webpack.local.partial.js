...
module.exports = {
    plugins: [
        new webpack.DefinePlugin({
            ...
            'ApiUrl': JSON.stringify('http://giddh-template.eu-west-1.elasticbeanstalk.com/'),
            ...
            'process.env.ApiUrl': JSON.stringify('http://giddh-template.eu-west-1.elasticbeanstalk.com/'),
