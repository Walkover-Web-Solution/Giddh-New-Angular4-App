// Electron production initialization script - moved from inline scripts for CSP compliance
...
// Electron production environment configuration
...
window.addEventListener('DOMContentLoaded', function() {
    ...
    try {
        ...
        const apiDomain = whiteLabelConfig?.body?.giddhWhiteLabel?.apiDomain || "https://api.giddh.com";
...
var HW_config = { selector: ".notification", account: "7eB4aJ" };
