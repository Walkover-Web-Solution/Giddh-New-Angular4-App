    ...
    public initializeEnvironment(): Promise<void> {
        return new Promise((resolve, reject) => {
            ...
            if (config && config.body) {
                const envUpdates = {
                    AppUrl: `https://${config.body.giddhWhiteLabel.domainName}/`,
                    ApiUrl: `https://${config.body.giddhWhiteLabel.apiDomainName}/`,
                    GOOGLE_CLIENT_ID: config.body.googleClientId,
                    GOOGLE_CLIENT_SECRET: config.body.googleClientSecret,
                    OTP_WIDGET_ID: config.body.otpWidgetId,
                    OTP_TOKEN_AUTH: config.body.otpWidgetToken,
                    PORTAL_URL: `https://${config.body.giddhWhiteLabel.portalDomain}/`,
                };
