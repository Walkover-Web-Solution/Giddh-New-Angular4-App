...
export class AuthenticationService {
    ...
    public GetElectronAppVersion() {
        ...
        args.headers = new HttpHeaders(args.headers);
        return this.httpClient.get('https://s3-ap-south-1.amazonaws.com/app-giddh-test/test/windows/latest/latest.yml', {
            headers: args.headers,
            responseType: 'text'
        }).pipe(map((res) => {
            return res;
    ...
    public getElectronMacAppVersion(): any {
        ...
        args.headers['Content-Type'] = 'application/xml';
        args.headers = new HttpHeaders(args.headers);
        return this.httpClient.get('https://s3-ap-south-1.amazonaws.com/app-giddh-test/test/mac/latest/latest-mac.yml', {
            headers: args.headers,
            responseType: 'text'
        }).pipe(map((res) => {
            return res;
