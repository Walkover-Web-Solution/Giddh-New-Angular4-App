export const VAT_API = {
    ...
    VIEW_KE_REPORT: 'company/:companyUniqueName/kenya/vat-report?from=:from&to=:to&taxNumber=:taxNumber',
    ...
    DOWNLOAD_KE_REPORT: 'company/:companyUniqueName/kenya/vat-report-download?from=:from&to=:to&taxNumber=:taxNumber&fileType=base64',
