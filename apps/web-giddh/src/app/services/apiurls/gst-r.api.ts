...
export const GSTR_API = {
    ...
    GET_TRANSACTIONS: `${COMMON_V2}/:gstType-transactions?gstin=:gstin&entityType=:entityType&type=:type&page=:page&count=:count&status=:status&from=:from&to=:to`,
    ...
    DOWNLOAD_SHEET: `${COMMON_V2}/:gstType-export-v2?gstin=:gstin&from=:from&to=:to&type=:sheetType`,
    ...
    DOWNLOAD_JSON: `${COMMON_V2}/gstr1/download-v2?gstin=:gstIn&from=:from&to=:to&type=:type`,
    ...
    CREATE_LUT_NUMBER: `${COMMON_URL}/gst-setting`,
    UPDATE_LUT_NUMBER: `${COMMON_URL}/gst-setting/:lutNumberUniqueName`,
