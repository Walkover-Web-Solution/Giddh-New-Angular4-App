...
const COMMON_URL_V4 = 'v4/company/:companyUniqueName/';
const EWAYBILL_COMMON_URL = 'company/:companyUniqueName/ewb';
const PART_A = 'v2/company/:companyUniqueName/';
const PART_B = 'accounts/:accountUniqueName/invoices/';
const PART_B_V2 = 'accounts/:accountUniqueName/vouchers/';
const URI_ONLY_FOR_INVOICE = `${PART_A}${PART_B}`;
