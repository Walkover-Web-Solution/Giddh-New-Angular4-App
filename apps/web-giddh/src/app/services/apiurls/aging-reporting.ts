...
const COMMON_URL_FOR_DUEAMOUNTREPORT_V2 = 'company/:companyUniqueName/due-amount-report?q=:q&page=:page&count=:count&sort=:sort&sortBy=:sortBy&rangeCol=:rangeCol';
