...
export const INVENTORY_API = {
    ...
    GET_FLATTEN_GROUP_WITH_ACCOUNTS: 'v2/company/:companyUniqueName/groups/:group/flatten-groups-with-accounts?query=:query&page=:page&count=:count&entity=:entity', // GET call
