...
export const INVENTORY_API = {
    ...
    GET_CUSTOMER_VENDOR_DISCOUNT_USERS: 'company/:companyUniqueName/customer-vendor-discount/get-all-users?groupUniqueName=:group&page=:page&count=:count', // GET call
    ...
    GET_ALL_DISCOUNTS: 'company/:companyUniqueName/customer-vendor-discount/get-all-discounts?uniqueName=:uniqueName', // GET call
