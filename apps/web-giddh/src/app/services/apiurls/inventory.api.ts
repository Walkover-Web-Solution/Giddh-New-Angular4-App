...
export const INVENTORY_API = {
    ...
    INVENTORY_SETTINGS: 'company/:companyUniqueName/inventory-settings',
    BUSINESS_DOCUMENT_STATUSES: 'company/:companyUniqueName/business-documents/statuses?documentType=:documentType'
};
