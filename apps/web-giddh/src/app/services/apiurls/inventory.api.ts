...
export const INVENTORY_API = {
    ...
    INVENTORY_ADJUST: {
        REPORT: 'company/:companyUniqueName/inventory-adjustment/adjustment-report?page=:page&&from=:from&to=:to&count=:count&sortBy=:sortBy&sort=:sort&q=:q&searchBy=:searchBy', // GET call
