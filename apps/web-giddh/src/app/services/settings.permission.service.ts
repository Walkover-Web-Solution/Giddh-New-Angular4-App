...
/**
 * SettingsPermissionService service
 * Provides settingspermission related business logic and data operations
 */
export class SettingsPermissionService {
    ...
    */
    /**
     * Handles GetUsersWithCompanyPermissions functionality
     */
