            ...
            (window as any).plugins.googleplus.login(
                {
                    ...
                    'webClientId': '641015054140-3cl9c3kh18vctdjlrt9c8v0vs85dorv2.apps.googleusercontent.com', // optional clientId of your Web application from Credentials settings of your project - On Android, this MUST be included to get an idToken. On iOS, it is not required.
                    'offline': true // optional, but requires the webClientId - if set to true the plugin will also return a serverAuthCode, which can be used to grant offline access to a non-Google server
                },
                (obj) => {
                    this.store.dispatch(this.loginAction.signupWithGoogle(obj));
