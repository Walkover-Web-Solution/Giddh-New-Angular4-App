...
export const ACCOUNTING_API = {
    ...
    ENTRY_SEARCH: `company/:companyUniqueName/accounts/:accountUniqueName/project-entries?from=:from&to=:to&page=:page&count=:count&branchUniqueName=:branchUniqueName&q=:q&category=:category`,
