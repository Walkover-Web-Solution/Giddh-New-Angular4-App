	...
	constructor(attrs?: any) {
		...
		if (attrs) {
			...
			if (attrs.addresses.length > 0) {
				...
				this.billingDetails.state.code = (attrs.addresses[0].state) ? attrs.addresses[0].state.stateGstCode : '';
				...
				this.shippingDetails.state.code = (attrs.addresses[0].state) ? attrs.addresses[0].state.stateGstCode : '';
