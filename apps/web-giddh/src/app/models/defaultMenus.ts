...
export let NAVIGATION_ITEM_LIST_ORIGINAL: IUlist[] = [
    ...
    { type: 'MENU', name: 'Purchase Bill ', uniqueName: '/pages/proforma-invoice/invoice/purchase' },
...
export let DEFAULT_MENUS_ORIGINAL: IUlist[] = [
    ...
    {
        type: 'MENU', name: 'Purchase Bill ', uniqueName: '/pages/proforma-invoice/invoice/purchase', isRemoved: false, pIndex: 7
    },
    {
