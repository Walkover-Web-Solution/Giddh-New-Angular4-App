...
// import { KeyboardNavigationModule } from '../helpers/directives/enter-next/keyboard-navigation.module'; // Module not found
...
@Component({
    ...
    imports: [
        ...
        HttpClientModule,
        A11yModule
        // KeyboardNavigationModule // Module not found
    ],
    providers: [
        {
