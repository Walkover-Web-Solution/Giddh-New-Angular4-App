...
export const allItems: AllItems[] = [
    {
        ["Customer"]: [
            { label: 'Invoice', link: '/pages/invoice/preview/sales', icon: 'icon-invoice-new', description: 'Lorem ipsum dolor sit amet, consectetur' },
            { label: 'Estimate', link: '/pages/invoice/preview/estimates', icon: 'icon-estimate-new', description: 'Lorem ipsum dolor sit amet, consectetur' },
            ...
            { label: 'Customer', link: '/pages/contact/customer', icon: 'icon-customer', description: 'Lorem ipsum dolor sit amet, consectetur' },
            ...
            { label: 'Credit Note', link: '/pages/invoice/preview/credit%20note', icon: 'icon-credit-note-new', description: 'Lorem ipsum dolor sit amet, consectetur' }
        ]
    },
    {
        ["Vendor"]: [
            ...
            { label: 'Template', link: '/pages/invoice/preview/templates/sales', icon: 'icon-template-new', description: 'Lorem ipsum dolor sit amet, consectetur' },
            { label: 'Debit Note', link: '/pages/invoice/preview/debit%20note', icon: 'icon-debit-note-new', description: 'Lorem ipsum dolor sit amet, consectetur' }
        ]
    },
    {
        ["Other Voucher"]: [
            { label: 'Credit Note', link: '/pages/invoice/preview/credit%20note', icon: 'icon-credit-note-new', description: 'Lorem ipsum dolor sit amet, consectetur' },
            { label: 'Debit Note', link: '/pages/invoice/preview/debit%20note', icon: 'icon-debit-note-new', description: 'Lorem ipsum dolor sit amet, consectetur' },
            { label: 'Recipt', link: '/pages/reports/receipt', icon: 'icon-reciept-new', description: 'Lorem ipsum dolor sit amet, consectetur' },
            { label: 'Template', link: '/pages/invoice/preview/templates/sales', icon: 'icon-template-new', description: 'Lorem ipsum dolor sit amet, consectetur' }
        ]
    },
    {
    ...
    },
    {
        ["Reports"]: [
            ...
            { label: 'TAX (GST)', link: '/pages/settings/taxes', icon: 'icon-tax-new', description: 'Lorem ipsum dolor sit amet, consectetur' },
            { label: 'E-way bill', link: '/pages/invoice/ewaybill', icon: 'icon-eway-bill-new', description: 'Lorem ipsum dolor sit amet, consectetur' }
        ]
    },
    {
        ["Import"]: [
            { label: 'Master', link: '/pages/trial-balance-and-profit-loss', icon: 'icon-master-new1', description: 'Lorem ipsum dolor sit amet, consectetur' },
    ...
    {
        ["Other"]: [
            { label: 'Petty Cash', link: '/pages/expenses-manager?tab=pending&tabIndex=0', icon: 'icon-petty-cash', description: 'Lorem ipsum dolor sit amet, consectetur' },
