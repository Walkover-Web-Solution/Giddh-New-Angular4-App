...
export class HeaderComponent implements OnInit, AfterViewInit, OnDestroy, AfterViewChecked {
    ...
    @ViewChild('dropdown', { static: false }) public companyDropdown: BsDropdownDirective;
    ...
    @ViewChild('searchCmpTextBox', { static: false }) public searchCmpTextBox: ElementRef;
    @ViewChild('expiredPlan', { static: false }) public expiredPlan: ModalDirective;
    ...
    @ViewChild('companyDetailsDropDownWeb', { static: false }) public companyDetailsDropDownWeb: BsDropdownDirective;
    /** All modules popover instance */
    @ViewChild('allModulesPopover', { static: false }) public allModulesPopover: PopoverDirective;
