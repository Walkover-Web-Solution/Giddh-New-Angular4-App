...
export class VoucherCreateComponent implements OnInit, OnDestroy, AfterViewInit {
    ...
    private fetchPreviousVouchers(): void {
        ...
        } else if (this.allowsSalesOptions || this.allowsPurchaseOptions || this.invoiceType.isCreditNote || this.invoiceType.isDebitNote) {
    ...
    private getCreatedTemplates(): void {
        this.componentStore.createdTemplates$.pipe(takeUntil(this.destroyed$)).subscribe((response) => {
            ...
            if (this.voucherType === VoucherTypeEnum.purchase || this.voucherType === VoucherTypeEnum.receiptNote) {
    ...
    */
    ...
    private getCopyParticularPreviewRequest(item: any, voucherType: string): any {
        if ([VoucherTypeEnum.sales, VoucherTypeEnum.creditNote, VoucherTypeEnum.debitNote, VoucherTypeEnum.purchase, VoucherTypeEnum.payment, VoucherTypeEnum.receipt, VoucherTypeEnum.deliveryChallan, VoucherTypeEnum.receiptNote].includes(voucherType as VoucherTypeEnum)) {
            return {
                voucherType,
