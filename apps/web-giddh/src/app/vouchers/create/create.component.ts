...
export class VoucherCreateComponent implements OnInit, OnDestroy, AfterViewInit {
    ...
    public saveVoucher(callback?: Function): void {
        ...
        if (this.invoiceType.isPurchaseOrder) {
            ...
            let accountUniqueName = this.invoiceType.isCashInvoice ? (invoiceForm.deposit?.accountUniqueName ?? invoiceForm.account?.uniqueName ?? 'cash') : invoiceForm.account?.uniqueName;
