...
export class LoginComponent implements OnInit, OnDestroy {
    ...
    public async appleLogin(): Promise<void> {
        ...
        const url = PRODUCTION_ENV || isElectron ? whiteLabel?.giddhWhiteLabel?.apiDomainName ? `${whiteLabel.giddhWhiteLabel.apiDomainName}` :  'https://api.giddh.com' : whiteLabel?.giddhWhiteLabel?.apiDomainName ? `${whiteLabel.giddhWhiteLabel.apiDomainName}` : 'https://apitest.giddh.com';
