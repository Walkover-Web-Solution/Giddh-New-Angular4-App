...
import { Configuration, OTP_PROVIDER_URL, URL_PROTOCOL } from "../app.constant";
...
export class LoginComponent implements OnInit, OnDestroy {
    ...
    public async appleLogin(): Promise<void> {
        ...
        const url = PRODUCTION_ENV || isElectron ? 'https://api.giddh.com' : whiteLabel?.giddhWhiteLabel?.apiDomainName ? URL_PROTOCOL + `${whiteLabel.giddhWhiteLabel.apiDomainName}` : 'https://apitest.giddh.com';
