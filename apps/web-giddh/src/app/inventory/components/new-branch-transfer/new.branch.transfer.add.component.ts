...
export class NewBranchTransferAddComponent implements OnInit, OnChanges, OnDestroy {
    ...
    @ViewChild('productSkuCode', { static: false }) public productSkuCode;
    @ViewChild('productHsnNumber', { static: false }) public productHsnNumber;
    @ViewChild('generateTransporterForm', { static: false }) public generateNewTransporterForm: NgForm;
    ...
    @ViewChild('productDescription', { static: false }) public productDescription;
