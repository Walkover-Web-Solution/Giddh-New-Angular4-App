                ...
                if (results[0]) {
                    ...
                    if (obj.voucherDetails) {
                        ...
                        if (this.currentVoucherFormDetails?.depositAllowed || (this.isPendingVoucherType && obj.accountDetails && obj.voucherDetails)) {
                            if (!this.isLastInvoiceCopied) {
                                obj.accountDetails.name = (this.isCashInvoice && results[0].account.customerName) ? results[0].account.customerName : results[0].account.name;
                                obj.voucherDetails.customerName = (this.isCashInvoice && results[0].account.customerName) ? results[0].account.customerName : results[0].account.name;
                            }
