...
export class ProformaInvoiceComponent implements OnInit, OnDestroy, AfterViewInit, OnChanges {
    ...
    @ViewChild('unregisteredBusiness', { static: false }) public unregisteredBusiness: ElementRef;

    @ViewChild('invoiceForm', { read: NgForm, static: false }) public invoiceForm: NgForm;
    ...
    @ViewChild('inputCustomerName', { static: false }) public inputCustomerName: ElementRef;
    @ViewChild('customerBillingAddress', { static: false }) public customerBillingAddress: ElementRef;
    ...
    @ViewChild('billingState', { static: false }) billingState: ElementRef;
    /** Shipping state instance */
    @ViewChild('shippingState', { static: false }) shippingState: ElementRef;

    /**Adjust advance receipts */
    @ViewChild('adjustPaymentModal', { static: true }) public adjustPaymentModal: ModalDirective;
    @ViewChild('advanceReceiptComponent', { static: false }) public advanceReceiptComponent: AdvanceReceiptAdjustmentComponent;
