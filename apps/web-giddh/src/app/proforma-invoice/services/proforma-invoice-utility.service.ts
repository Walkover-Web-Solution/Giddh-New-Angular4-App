    ...
    public getVoucherRequestObjectForInvoice(data: any): any {
        ...
        if (data.account) {
            ...
            if (data.account.billingDetails) {
                data.account.billingDetails.taxNumber = (data.account.billingDetails.gstNumber) ? data.account.billingDetails.gstNumber : (data.account.billingDetails.taxNumber) ? data.account.billingDetails.taxNumber : "";
            ...
            if (data.account.shippingDetails) {
                data.account.shippingDetails.taxNumber = (data.account.shippingDetails.gstNumber) ? data.account.shippingDetails.gstNumber : (data.account.shippingDetails.taxNumber) ? data.account.shippingDetails.taxNumber : "";
