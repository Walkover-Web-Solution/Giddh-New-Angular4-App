...
export const MOBILE_NUMBER_IP_ADDRESS_URL = 'http://ip-api.com/json/${res.response.ipAddress';
export const MOBILE_NUMBER_ADDRESS_JSON_URL = 'https://ipinfo.io/${res.response.ipAddress}/json';
