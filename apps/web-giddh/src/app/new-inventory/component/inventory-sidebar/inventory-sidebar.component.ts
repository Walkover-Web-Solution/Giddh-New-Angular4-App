            ...
            this.dataList = [
                {
                    ...
                    children: [
                        ...
                        { name: 'Inventory Adjustment', icons: 'home-icon-black.svg', link: '/pages/inventory/v2/product/adjust-inventory', hiddenLink: ['/pages/inventory/v2/product/adjust-inventory/create'] }
                    ],
                },
                {
                    ...
                    children: [
                        ...
                        { name: 'Inventory Adjustment', icons: 'home-icon-black.svg', link: '/pages/inventory/v2/service/adjust-inventory', hiddenLink: ['/pages/inventory/v2/service/adjust-inventory/create'] }
                    ],
                },
                {
