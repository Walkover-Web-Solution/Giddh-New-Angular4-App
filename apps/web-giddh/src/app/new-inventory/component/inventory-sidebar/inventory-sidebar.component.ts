            ...
            this.dataList = [
                ...
                },
                {
                    ...
                    icons: 'branch-transfer.svg',
                     children: [
                        { name: this.localeData?.sidebar?.create_branch_transfer, icons: 'create-new.svg',openActiveMenu: true, moduleType: '' },
                ...
                },
                {
                    ...
                    children: [
                        { name: this.localeData?.sidebar?.create_manufacturing, icons: 'create-new.svg', link: '/pages/inventory/v2/manufacturing/new' },
