...
export class ReportsComponent implements OnInit {
    ...
    */
    ...
    public getReportsByReportType(element: any): void {
        ...
        if (this.reportType === InventoryReportType.group) {
            if (element?.stockGroupHasChild) {
                currentUrl = '/pages/inventory/v2/reports/group/' + element?.stockGroup?.uniqueName;
                ...
                currentUrl = '/pages/inventory/v2/reports/stock/' + element?.stockGroup?.uniqueName;
                this.storeFilters[currentUrl] = { stockReportRequest: stockReportRequest, balanceStockReportRequest: balanceStockReportRequest, todaySelected: this.todaySelected, showClearFilter: this.showClearFilter };
                this.store.dispatch(this.commonAction.setFilters(this.storeFilters));
            ...
            currentUrl = '/pages/inventory/v2/reports/variant/' + element?.stock?.uniqueName;
            this.storeFilters[currentUrl] = { stockReportRequest: stockReportRequest, balanceStockReportRequest: balanceStockReportRequest, todaySelected: this.todaySelected, showClearFilter: this.showClearFilter };
            this.store.dispatch(this.commonAction.setFilters(this.storeFilters));
            ...
            currentUrl = '/pages/inventory/v2/reports/transaction/' + element?.variant?.uniqueName;
            this.storeFilters[currentUrl] = { stockReportRequest: stockReportRequest, balanceStockReportRequest: balanceStockReportRequest, todaySelected: this.todaySelected, showClearFilter: this.showClearFilter };
            this.store.dispatch(this.commonAction.setFilters(this.storeFilters));
    ...
    public editGroup(element: any): void {
        this.router.navigate(['/pages', 'inventory/v2', this.reportType?.toLowerCase(), this.moduleType?.toLowerCase(), 'edit', element?.stockGroup?.uniqueName]);
    }
    /**
    ...
    public editStock(element: any): void {
        this.router.navigate(['/pages', 'inventory/v2', this.reportType?.toLowerCase(), this.moduleType?.toLowerCase(), 'edit', element?.stock?.uniqueName]);
    }
    /**
    ...
    public editVariant(element: any): void {
        console.log(this.reportType, this.moduleType);
