...
export interface PeriodicElement {
  ...
  const ELEMENT_DATA: PeriodicElement[] = [
    ...
    {position: 4, date: 302023, weight: 'PO-20230630-1', symbol: '17 April', total: '₹1,148.00', expected: "Delayed By 399 Days", status: 'Converted'},    {position: 1, date: 302023302023, weight: 'PO-20230630-1', symbol: '17 April', total: '₹1,148.00', expected: "Delayed By 399 Days", status: 'Cancelled'},
    {position: 2, date: 302023, weight: 'PO-20230630-1', symbol: '17 April', total: '₹1,148.00', expected: "Delayed By 399 Days", status: 'Expired'},
    {position: 3, date: 302023, weight: 'PO-20230630-1', symbol: '17 April', total: '₹1,148.00', expected: "Delayed By 399 Days", status: 'Open'},
    {position: 4, date: 302023, weight: 'PO-20230630-1', symbol: '17 April', total: '₹1,148.00', expected: "Delayed By 399 Days", status: 'Converted'},    {position: 1, date: 302023302023, weight: 'PO-20230630-1', symbol: '17 April', total: '₹1,148.00', expected: "Delayed By 399 Days", status: 'Cancelled'},
    {position: 2, date: 302023, weight: 'PO-20230630-1', symbol: '17 April', total: '₹1,148.00', expected: "Delayed By 399 Days", status: 'Expired'},
