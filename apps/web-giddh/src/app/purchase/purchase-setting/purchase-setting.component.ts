...
export class PurchaseSettingComponent implements OnInit, OnDestroy {
    ...
    public invoiceSettings: any = { purchaseBillSettings: { sendThroughGmail: false, autoWhatsApp: false, changePOStatusOnExpiry: false, useCustomPONumber: false, enableNarration: false, enableVoucherDownload: false }, invoiceSettings: { purchaseRoundOff: false, generateAutoPurchaseNumber: false } };
