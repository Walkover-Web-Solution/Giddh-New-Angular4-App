...
export class BillingDetailComponent implements OnInit, OnDestroy, AfterViewInit {
    ...
    ngAfterViewInit(): void {
        ...
        let that = this;
        let testEnvAuthkeyForRazorpay = s.src = 'https://checkout.razorpay.com/v1/checkout.js';
        s.type = 'text/javascript';
        document.body.appendChild(s);
        this.options = {
            key: 'rzp_live_rM2Ub3IHfDnvBq',   // rzp_live_rM2Ub3IHfDnvBq   // rzp_test_QS3CQB90ukHDIF //rzp_live_rM2Ub3IHfDnvBq
