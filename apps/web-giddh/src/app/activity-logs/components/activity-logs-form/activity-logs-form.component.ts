...
import { ActivityLogsSidebarVM } from './Vm';

@Component({
    selector: 'activity-logs-form',
    templateUrl: './activity-logs-form.component.html',
    styleUrls: ['activity-logs-form.component.scss']
})
export class ActivityLogsFormComponent implements OnInit, OnDestroy {
    /** This will hold local JSON data */
    @Input() public localeData: any = {};
    /** This will hold common JSON data */
    @Input() public commonLocaleData: any = {};
    /** Audit log form object */
    public auditLogFormVM: ActivityLogsSidebarVM;
    /** Date format type */
    ...
    public ngOnInit(): void {
        this.auditLogFormVM = new ActivityLogsSidebarVM(this.localeData, this.commonLocaleData);
