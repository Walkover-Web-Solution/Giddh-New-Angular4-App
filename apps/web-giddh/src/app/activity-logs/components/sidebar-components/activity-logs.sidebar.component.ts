...
@Component({
    selector: 'activity-logs-sidebar',
    templateUrl: './activity-logs.sidebar.component.html',
    styleUrls: ['activity-logs.sidebar.component.scss']
})
export class ActivityLogsSidebarComponent implements OnInit, OnDestroy {
    /** This will hold local JSON data */
    @Input() public localeData: any = {};
    /** This will hold common JSON data */
    @Input() public commonLocaleData: any = {};
    public vm: ActivityLogsSidebarVM;
    ...
    public ngOnInit() {
        this.vm = new ActivityLogsSidebarVM(this.localeData, this.commonLocaleData);
