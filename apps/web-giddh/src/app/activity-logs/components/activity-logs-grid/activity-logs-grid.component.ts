...
@Component({
    selector: 'activity-logs-grid',
    templateUrl: './activity-logs-grid.component.html',
    styleUrls: [`./activity-logs-grid.component.scss`]
})
export class ActivityLogsGridComponent implements OnInit, OnDestroy {
