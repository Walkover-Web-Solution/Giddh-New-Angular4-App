import { Component, OnInit, OnDestroy, ChangeDetectorRef, ViewChild, ElementRef, TemplateRef } from '@angular/core';
...
export class ReverseChargeReport implements OnInit, OnDestroy {
    ...
    public ngOnInit(): void {
        ...
        this.store.pipe(select((states: AppState) => states.session.applicationDate), takeUntil(this.destroyed$)).subscribe((dateObj: Date[]) => {
            if (dateObj) {
