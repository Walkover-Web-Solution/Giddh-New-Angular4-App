...
export const ROUTES: Routes = [
    ...
    { path: 'material-ledger', redirectTo: 'pages/material-ledger' },
    ...
    { path: 'billing-detail/buy-plan', component: BillingDetailComponent },
    {
        ...
        children: [
            ...
            { path: 'material-ledger', loadChildren: () => import('./material-ledger/ledger.module').then(module => module.LedgerModule), canActivate: [NeedsAuthorization] },
