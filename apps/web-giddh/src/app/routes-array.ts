...
export const ROUTES: Routes = [
    ...
    { path: 'triggers', redirectTo: 'pages/triggers', pathMatch: 'full' },
    ...
    { path: 'ocr-voucher', loadChildren: () => import('./ocr-voucher/ocr-voucher.module').then(module => module.OcrVoucherModule) },
    ...
    { path: 'ocr-voucher', redirectTo: 'pages/ocr-voucher', pathMatch: 'full' },
