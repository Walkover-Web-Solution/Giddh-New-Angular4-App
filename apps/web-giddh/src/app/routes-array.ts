export const ROUTES = [
  ...
  { path: 'new-vs-old-invoices', redirectTo: 'pages/new-vs-old-invoices', pathMatch: 'full' },
  {
    ...
    children: [
      ...
      { path: 'invoice', loadChildren: './invoice/invoice.module#InvoiceModule', data: { preload: true } },
      { path: 'sales', loadChildren: './sales/sales.module#SalesModule', data: { preload: true } },
      ...
      { path: 'inventory', loadChildren: './inventory/inventory.module#InventoryModule', data: { preload: true } },
      {
      ...
      { path: 'settings', loadChildren: './settings/settings.module#SettingsModule', data: { preload: true } },
      {
        path: 'manufacturing',
