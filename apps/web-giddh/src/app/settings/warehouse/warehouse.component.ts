...
// COMMENTED OUT - INJECTION ISSUE: import { VoucherComponentStore } from '../../vouchers/utility/vouchers.store';
...
@Component({
    ...
    // COMMENTED OUT - INJECTION ISSUE: providers: [VoucherComponentStore]
})
export class WarehouseComponent implements OnInit, OnDestroy, AfterViewInit {
    ...
    constructor(
        ...
        // COMMENTED OUT - INJECTION ISSUE: private componentStore: VoucherComponentStore
    ) { }
    ...
    public ngOnInit(): void {
        ...
        // COMMENTED OUT - INJECTION ISSUE: this.componentStore.branchList$.pipe(takeUntil(this.destroyed$)).subscribe(response => {
        //     if (response) {
