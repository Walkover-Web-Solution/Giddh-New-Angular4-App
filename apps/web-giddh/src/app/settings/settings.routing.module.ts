...
@NgModule({
    imports: [
        RouterModule.forChild([
            ...
            {
                // COMMENTED OUT - COMPILATION ERROR: path: ':type', component: SettingsComponent, canActivate: [NeedsAuthentication, NeedsAuthorization], canDeactivate: [SettingsDeactivateGuard, PageLeaveConfirmationGuard]
            },
            {
                // COMMENTED OUT - COMPILATION ERROR: path: ':type/:referrer', component: SettingsComponent, canActivate: [NeedsAuthentication, NeedsAuthorization], canDeactivate: [SettingsDeactivateGuard, PageLeaveConfirmationGuard]
            }
        ])
    ],
    providers: [
