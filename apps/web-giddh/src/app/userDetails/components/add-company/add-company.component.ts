    ...
    public ngOnInit(): void {
        if (this.allAssociatedCompanies && this.allAssociatedCompanies.length > 0) {
            this.allAssociatedCompanies.forEach(company => {
                ...
                if (this.activeCompany.subscription.planDetails.countries.includes(company.subscription.country.countryName) && this.activeCompany.subscription.planDetails.uniqueName !== company.subscription.planDetails.uniqueName) {
