...
module.exports = {
    plugins: [
        new webpack.DefinePlugin({
            ...
            'OTP_WIDGET_ID': JSON.stringify('336c626b5072353637333839'),
            'OTP_TOKEN_AUTH': JSON.stringify('278060TX9AIhxEpR7H6427de5cP1'),
            ...
            'process.env.OTP_TOKEN_AUTH': JSON.stringify('278060TX9AIhxEpR7H6427de5cP1'),
