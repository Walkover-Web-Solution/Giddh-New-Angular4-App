...
module.exports = {
    plugins: [
        new webpack.DefinePlugin({
            ...
            'AppUrl': JSON.stringify('http://giddh-test-app.ap-south-1.elasticbeanstalk.com/'),
           ...
           'process.env.GOOGLE_CLIENT_ID': 'window["process.env.GOOGLE_CLIENT_ID"] || ' + JSON.stringify(process.env.GOOGLE_CLIENT_ID_TEST),
            ...
            'process.env.AppUrl': 'window["process.env.AppUrl"] || ' + JSON.stringify('http://giddh-test-app.ap-south-1.elasticbeanstalk.com'),
