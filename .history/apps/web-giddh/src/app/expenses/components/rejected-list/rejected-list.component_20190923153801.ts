...
export class RejectedListComponen implements OnInit {
  ...
  RejectedItem = [
    {No: 1, date: '29-07-2019', SubmittedBy: 'Pratik Piplode', acount: 'Stationery A/c', dotWarning: 'dot-warning', dotPrimary: '' ,dotSuccess: '' ,mount: 1400, payment: 'ICICI A/c',
    ...
    {No: 2, date: '29-07-2019', SubmittedBy: 'Pratik Piplode', acount: 'Fuel A/c', dotWarning: '', dotPrimary: 'dot-primary' ,dotSuccess: '', amount: 1400, payment: 'Cash A/c',
    ...
    {No: 3, date: '29-07-2019', SubmittedBy: 'Pratik Piplode', acount: 'Stationery A/c', dotWarning: 'dot-warning', dotPrimary: '' ,dotSuccess: '', amount: 1400, payment: 'SBI A/c',
    ...
    {No: 4, date: '29-07-2019', SubmittedBy: 'Pratik Piplode', acount: 'Fuel A/c', dotWarning: '', dotPrimary: 'dot-primary' ,dotSuccess: '', amount: 1400, payment: 'Cash A/c',
    card: '', cash: 'icon-cash',  File: 'attach file', FileIcon: 'icon-file-path', ImgeIcon: '', ImgePath: '', multipleIcon: '', multiple: '', description: 'Dummy text sample test', Action: ''},
    {No: 5, date: '29-07-2019', SubmittedBy: 'Pratik Piplode', acount: 'Others', dotWarning: '', dotPrimary: 'dot-primary' ,dotSuccess: '', amount: 1400, payment: 'ICICI A/c',
    ...
    {No: 6, date: '29-07-2019', SubmittedBy: 'Pratik Piplode', acount: 'Money Request', dotWarning: '', dotPrimary: '' ,dotSuccess: 'dot-success', amount: 1400, payment: 'Cash A/c',
