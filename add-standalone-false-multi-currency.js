...
/**
 * Script to add standalone: false to all @Component decorators in multi-currency-reports directory
...
function main() {
    const targetDirectory = './apps/web-giddh/src/app/multi-currency-reports';
